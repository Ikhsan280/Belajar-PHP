...
<input type="hidden" name="namamobil1" value=<?php echo "$namamobil";?> >
...
<input type="hidden" name="nomobil" value=<?php echo "$plat";?> >

    <table>
    <tr>
            <td><b>Tanggal Pengembalian</b></td>
            <td> : </td>
            <td><input  type="date" name="tanggalverivikasi"></td>
